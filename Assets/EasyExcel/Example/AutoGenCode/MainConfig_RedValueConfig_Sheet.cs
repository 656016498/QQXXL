...
{
	[Serializable]
	public class RedValueConfig : EERowData
	{
		[EEKeyField]
		[SerializeField]
		private int _ID;
		...
		public RedValueConfig()
		{
		}

#if UNITY_EDITOR
		public RedValueConfig(List<List<string>> sheet, int row, int column)
		{
	...
	public class MainConfig_RedValueConfig_Sheet : EERowDataCollection
	{
		[SerializeField]
		private List<RedValueConfig> elements = new List<RedValueConfig>();

		public override void AddData(EERowData data)
		{
			elements.Add(data as RedValueConfig);
		}
